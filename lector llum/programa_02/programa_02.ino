...
/*****************************************************************
**                                                              **
**             sensor crepuscular amb diferents leds            **
**                                                              **
**                                                              **
**                                                              **
*****************************************************************/
...
void loop() {                 //Inicia el bucle del programa
  ...
  valLdr0 = map(valLdr0, 0,532 , 0, 255);   // mapejar valor de 0-1023 a 0-255
  ...
  valLdr1 = map(valLdr1, 0,560 , 0, 255);   // mapejar valor de 0-1023 a 0-255
  ...
  valLdr2 = map(valLdr2, 0, 594, 0, 255);   // mapejar valor de 0-1023 a 0-255
